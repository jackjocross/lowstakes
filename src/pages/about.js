...
const About = () => (
  <PageWrapper>
    <Card padding={GUTTER.LG}>
      ...
      eget aliquet nibh praesent. Rhoncus urna neque viverra justo. Enim tortor
      at auctor urna nunc. Nam aliquam sem et tortor consequat id porta. Est sit
      amet facilisis magna. Tempus egestas sed sed risus pretium quam vulputate.
      Ut morbi tincidunt augue interdum velit euismod. Et malesuada fames ac
      turpis egestas maecenas pharetra. Nunc lobortis mattis aliquam faucibus
      purus in massa tempor.\n\nSem fringilla ut morbi tincidunt. Vestibulum
      rhoncus est pellentesque elit. In fermentum posuere urna nec tincidunt
      praesent. Volutpat blandit aliquam etiam erat velit scelerisque in dictum
      non. Et netus et malesuada fames. Ut sem nulla pharetra diam sit amet nisl
      suscipit adipiscing. Auctor elit sed vulputate mi sit amet mauris commodo.
      <p>
